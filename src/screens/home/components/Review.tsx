            ...
            <View className='flex-1 items-center justify-center mr-2'>
                ...
                <View className='mt-1'>
                    <Text className='text-[9px] text-gray-500'>
                        Your review helps us improve the app and serve you better.Share your thoughts to shape future updates and assist others in making informed choices.We value your feedback-thanks for contributing.
                    </Text>
                </View>
                <View className='mt-9'>
                    <TouchableOpacity className='border border-gray-400 py-2 w-48 rounded-md'>
                        <Text className='text-center font-extrabold text-primary'>Write a Review!</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
