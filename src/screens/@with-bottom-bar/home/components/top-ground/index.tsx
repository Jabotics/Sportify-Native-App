...
const TopGroundComponent = () => (
  <View className="w-32 h-52 rounded-md overflow-hidden relative mx-1">
    ...
    <View
      ...
      className="bg-black opacity-60 mx-4 rounded p-[3px]"
    >
      <Text className="text-white font-normal text-[12px] opacity-100">
        Maidan Swiming Pool
      </Text>
    </View>
    <View
      ...
      className="bg-black opacity-60 rounded flex flex-row mx-4 p-[2px]"
    >
