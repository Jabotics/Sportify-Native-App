...
const Questions = ({ question }: { question: string }) => (
  <TouchableOpacity>
    <View className="bg-gray-50 p-4 mx-4 rounded-md flex flex-row justify-between items-center">
      <View className="flex flex-row items-center flex-1">
        <View className="w-8 h-8 rounded-full bg-stone-200"></View>
        <View className="mx-2 flex-1">
          <Text className="text-xs font-normal" numberOfLines={2}>
            {question}
          </Text>
        </View>
      </View>
