    ...
    return (
        <View className='w-48 h-60 bg-white rounded-md overflow-hidden border border-gray-300'>
            <View className='h-32 relative'>
                <Image source={require('@/assets/images/temp/ground.jpg')} className='w-[100%] h-[100%]' style={{ resizeMode: 'cover' }} />
                ...
                <View style={{ position: 'absolute', top: 10, right: 10, justifyContent: 'center', alignItems: 'center' }} className='bg-stone-600 w-5 flex flex-row rounded p-[2px]'>
            ...
            <View className='mt-2'>
                ...
                <View className='ml-2'>
                    <Text className='text-primary underline font-semibold text-[10px]'>Riverside Avani Mall Ground</Text>
                </View>
